function CheckCircleIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4A7C8C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const FEATURES = [
  ...
  { Icon: BellIcon, title: 'Automatic Reminders',
    body: 'Vigilight follows up when tasks approach their deadline. Staff get reminded so nothing slips through the cracks.' },
  { Icon: MicIcon, title: 'Meeting Intelligence',
    body: 'Record your arrangement conference. Vigilight transcribes it and automatically extracts tasks for the service.' },
